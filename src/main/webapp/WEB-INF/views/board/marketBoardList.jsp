			...
			<div class="pagination">
		        <ul>
		          <c:if test="${currentPage > 1}">
		            <li><a href="${pageContext.request.contextPath}/board/marketBoardList.do?page=${currentPage - 1}" >&laquo;</a></li>
		          </c:if>
		          ...
		          <c:forEach var="pageNum" begin="1" end="${totalPages}">
		            <c:choose>
		              ...
		              <c:otherwise>
		                <li><a href="${pageContext.request.contextPath}/board/marketBoardList.do?page=${pageNum}">${pageNum}</a></li>
		              </c:otherwise>
		            </c:choose>
		          </c:forEach>
