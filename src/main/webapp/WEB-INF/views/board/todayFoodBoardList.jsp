...
.pagination ul li.active a {
  font-weight: bold;
	...
	<div class="wrap title">
		<h1>
			<a>오늘 뭐 먹지?</a>
			<i class="bi bi-star" data-value="${todayFoodBoardList[0].boardId}"></i>
		</h1>
	</div>
	<div class="wrap articles">
		...
		<c:if test="${empty todayFoodBoardList}">
			<article class="dialog">
				조회된 게시글이 존재하지 않습니다.
			</article>
		</c:if>
		<c:if test="${not empty todayFoodBoardList}">
			<article>
				<c:forEach items="${todayFoodBoardList}" var="board">
			...
			<ul class="pagination justify-content-center">
	      	<c:if test="${currentPage > 1}">
			    <li class="page-item">
			        <li>
			        	<a class="page-link" href="${pageContext.request.contextPath}/board/todayFoodBoardList.do?page=${currentPage - 1}" aria-label="Previous">
			        		&laquo;
			        	</a>
			        </li>
		    ...
		    <li class="page-item">
		    	<c:forEach var="pageNum" begin="1" end="${totalPages}">
		            <c:choose>
		              ...
		              <c:otherwise>
		                <li><a class="page-link" href="${pageContext.request.contextPath}/board/todayFoodBoardList.do?page=${pageNum}">${pageNum}</a></li>
		              </c:otherwise>
		            </c:choose>
		        </c:forEach>
		    </li>
		    <li class="page-item">
		      <a class="page-link" href="#" aria-label="Next">
		            ...
		            <li><a href="${pageContext.request.contextPath}/board/todayFoodBoardList.do?page=${currentPage + 1}" ></a></li>
		          </c:if>
	...
	* 해당 게시물은 홍보게시판에만 작성 가능합니다. 
	...
	- 스포일러, 공포, 속임, 놀라게 하는 행위" class="smallplaceholder" id="text"></textarea>
        	...
        	<button type="submit" class="submitBtn" style="float: right;" ><span class="material-symbols-outlined" >edit</span></button>
