...
.pagination ul li.active a {
  font-weight: bold;
	...
	<div class="wrap title">
		<h1>
			<a>예비생게시판</a>
			<i class="bi bi-star" data-value="${preStudentBoardList[0].boardId}"></i>
		</h1>
	</div>
		...
		<c:if test="${not empty preStudentBoardList}">
			...
			<ul class="pagination justify-content-center">
	      	<c:if test="${currentPage > 1}">
			    <li class="page-item">
			        <li>
			        	<a class="page-link" href="${pageContext.request.contextPath}/board/preStudentBoardList.do?page=${currentPage - 1}" aria-label="Previous">
			        		&laquo;
			        	</a>
			        </li>
		    ...
		    <li class="page-item">
		    	<c:forEach var="pageNum" begin="1" end="${totalPages}">
		            <c:choose>
		              ...
		              <c:otherwise>
		                <li><a class="page-link" href="${pageContext.request.contextPath}/board/preStudentBoardList.do?page=${pageNum}">${pageNum}</a></li>
		              </c:otherwise>
		            </c:choose>
		        </c:forEach>
		    </li>
		    <li class="page-item">
		      <a class="page-link" href="#" aria-label="Next">
		            ...
		            <li><a href="${pageContext.request.contextPath}/board/preStudentBoardList.do?page=${currentPage + 1}" ></a></li>
		          </c:if>
