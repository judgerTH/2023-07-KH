...
.pagination ul li.active a {
  font-weight: bold;
	...
	<div class="wrap title">
		<h1>
			<a>정보공유게시판</a>
			<i class="bi bi-star" data-value="${sharingInformationBoardList[0].boardId}"></i>
		</h1>
	</div>
	<div class="wrap articles">
		...
		<c:if test="${empty sharingInformationBoardList}">
			<article class="dialog">
				조회된 게시글이 존재하지 않습니다.
			</article>
		</c:if>
		<c:if test="${not empty sharingInformationBoardList}">
			<article>
			...
			<ul class="pagination justify-content-center">
	      	<c:if test="${currentPage > 1}">
			    <li class="page-item">
			        <li>
			        	<a class="page-link" href="${pageContext.request.contextPath}/board/sharingInformationBoardList.do?page=${currentPage - 1}" aria-label="Previous">
			        		&laquo;
			        	</a>
			        </li>
		    ...
		    <li class="page-item">
		    	<c:forEach var="pageNum" begin="1" end="${totalPages}">
		            <c:choose>
		              ...
		              <c:otherwise>
		                <li><a class="page-link" href="${pageContext.request.contextPath}/board/sharingInformationBoardList.do?page=${pageNum}">${pageNum}</a></li>
		              </c:otherwise>
		            </c:choose>
		        </c:forEach>
		    </li>
		    <li class="page-item">
		      <a class="page-link" href="#" aria-label="Next">
		            ...
		            <li><a href="${pageContext.request.contextPath}/board/sharingInformationBoardList.do?page=${currentPage + 1}" ></a></li>
		          </c:if>
