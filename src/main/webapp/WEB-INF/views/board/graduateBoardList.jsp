...
.pagination ul li.active a {
  font-weight: bold;
	...
	<div class="wrap title">
		<h1>
			<a>수료생게시판</a>
			<i class="bi bi-star" data-value="${graduateBoardList[0].boardId}"></i>
		</h1>
	</div>
	<div class="wrap articles">
		...
		<c:if test="${empty graduateBoardList}">
		...
		<c:if test="${not empty graduateBoardList}">
			...
			<ul class="pagination justify-content-center">
	      	<c:if test="${currentPage > 1}">
			    <li class="page-item">
			        <li>
			        	<a class="page-link" href="${pageContext.request.contextPath}/board/graduateBoardList.do?page=${currentPage - 1}" aria-label="Previous">
			        		&laquo;
			        	</a>
			        </li>
		    ...
		    <li class="page-item">
		    	<c:forEach var="pageNum" begin="1" end="${totalPages}">
		            <c:choose>
		              ...
		              <c:otherwise>
		                <li><a class="page-link" href="${pageContext.request.contextPath}/board/graduateBoardList.do?page=${pageNum}">${pageNum}</a></li>
		              </c:otherwise>
		            </c:choose>
		        </c:forEach>
		    </li>
