		...
		<c:if test="${not empty boards}">
			<article>
				<c:forEach items="${boards}" var="board">
					<a class="article"
						href="${pageContext.request.contextPath}/board/boardDetail.do?id=${board.postId}">
						<img class="picture medium"
						src="${pageContext.request.contextPath}/resources/images/usericon.png" />
						<h3 class="medium">익명</h3> <time class="medium">
						<!-- pattern="yyyy-MM-dd'T'HH:mm:ss" ss수정했습니다. -->
						...
						<p class="medium">${board.content}</p> <br> <span
						class="boardName">${board.boardName}</span>
						<ul class="status">
							<li><img
