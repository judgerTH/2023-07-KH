...
<div id="container">
    ...
    <div class="agreement">
      ...
      <div class="text">
<h3>제1조(목적)</h3>
<p>KhTIME 서비스 이용약관은 비누랩스 주식회사(이하 "회사"라 합니다)가 제공하는 KhTIME 서비스 및 캠퍼스픽 서비스의 이용과 관련하여 회사와 이용자 간의 권리, 의무 및 책임 사항 등을 규정함을 목적으로 합니다.</p>
...
<ol>
  ...
  <li>KhTIME은 학생증, 학교 웹메일, 증명서 등을 통해 해당 대학교의 학부 재학생 및 졸업생 또는 해당연도 입학생으로 인증받은 이용자에 한해 커뮤니티를 이용할 수 있는 폐쇄형 서비스입니다. KhTIME은 대학교별로 개별 운영되므로, 학교 인증을 받지 않은 이용자 및 불특정 다수의 일반 이용자는 커뮤니티를 포함한 대부분의 기능에 접근할 수 없습니다.</li>
...
<ol>
  ...
  <li>게시판 관리자는 KhTIME 계정을 탈퇴할 수 없습니다. 탈퇴를 위해서는 자신이 관리중인 게시판을 삭제하거나 다른 회원에게 관리자 권한을 양도해야 합니다. 단, 게시판 개설 혹은 마지막 게시물 게시 이후, 14일 동안 활동이 없는 게시판만 삭제할 수 있습니다.</li>
...
<ol>
  ...
  <li>기간 : 탈퇴 후 최대 1년</li>
      ...
      <div class="text small">
        ...
        <p>KhTIME은 철저한 학교 인증과 안전한 익명 커뮤니티를 제공하기 위해, 가입 시 본인 인증 수단을 통해 본인 여부를 확인하고, 커뮤니티 이용 시 증명 자료 제출을 통해 재학 여부를 확인합니다. 두 정보가 일치하지 않을 경우 서비스를 이용하실 수 없습니다.</p>
      </div>
      <label class="bold"><input type="checkbox" name="agreement_age14"><figure class="checkbox"></figure>만 14세 이상입니다.</label>
      <div class="text small">
        <p>KhTIME은 국내 대학생을 위한 서비스이며, 본인 인증을 통해 만 14세 이상만 가입할 수 있습니다.</p>
      </div>
    </div>
